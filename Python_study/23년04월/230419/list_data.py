...
# li = [1,2,3,4]
# a = li.pop() # idx 입력이 없으므로 맨 뒤 4를 pop. 
# print(li) # [1,2,3]
# print(a) # 4 pop 값
# b = li.pop(1) # idx [1] 자리 값(2)을 pop
# print(li) # [1,3]
# print(b) #2
...
# 리스트의 요소를 정렬한다.
# li = [5,3,1,4,2]
# # li.sort() # 1,2,3,4,5 오름차순 정순
# li.sort(reverse=True) # 5,4,3,2,1 내림차순 역순
# print(li)
...
# print(cnt) # 또는 print(li.conut(2))  # 2
