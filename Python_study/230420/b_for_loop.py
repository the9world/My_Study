...
#       pass # 아무것도 안하고 그냥 넘어갈 때(다음 으로 넘어감)
#     else : # 짝수
#             print(i)
# for i in range(2, 31) : 
...
# for i in range(len(prices)): # 무조건 괄호 안 부터 # index 기준 0, 1, 2, 3
...
#     for j in range(1, 10): # 1 ~ 9  # 안 쪽 for문 먼저 순회  # 뒷 자리
#         print(i, "*", j, "=", i*j)
#     print("----------") # 각 단 끝날때 마다 i 값이 바뀌기 전에 들어가게 하기 위해
